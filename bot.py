...
class Settings:
    ...
    def __str__(self):
        return "{},{},{},{},{},{},{}".format(self.RemovedBlocked, self.MergeDuplicates, self.AutoMark, self.FixInstructions, self.AutoBacklog, self.AddLimit, self.RemoveLimit)
...
def check_instructions(page: pywikibot.Page):
    ...
    if instructionPage.exists():
        ...
        rex = re.compile("<!-- HBC AIV helperbot BEGIN INSTRUCTIONS -->\n(.*)\n<!-- HBC AIV helperbot END INSTRUCTIONS -->", flags=re.DOTALL)
